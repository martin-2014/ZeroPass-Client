import component from './ja-JP/component.json';
import menu from './ja-JP/menu.json';
import pages from './ja-JP/pages.json';
import login from './ja-JP/login.json';
...
import notification from './ja-JP/notification.json';
import settings from './ja-JP/settings.json';
import country from './ja-JP/glossaries.json';
import tip from './ja-JP/tip.json';
import password from './ja-JP/password.json';
import wallet from './ja-JP/wallet.json';
import sync from './ja-JP/sync.json';
import dataStorage from './ja-JP/dataStorage.json';
