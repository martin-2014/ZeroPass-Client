...
export const preloadCallback = {
    ...
    sendMessageToExtensions: (extensionsMessage: Message.ExtensionsMessage) => {
    ...
    safeCache: {
        ...
        getItem: (key: string) => ipcRenderer.sendSync("get-cache-item", key),
